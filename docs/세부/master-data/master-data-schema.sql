...
--    기사는 방어 특화 직업이라 atk 12로 4직업 중 가장 낮고(슬레이어 15보다 20% 아래), 그만큼 느린 처리력을
--    hp 1300 · def 100(유효 체력 2,600 = 2위의 3.4배)으로 되갚아 1지역 솔로를 성립시킨다(값 문서 §2·§9.2).
-- =====================================================================
...
INSERT INTO class_master (class_code, name, description, unlock_type, hp, atk, def, move_speed, crit_chance, crit_damage, cooldown) VALUES
    (1, '기사',   '높은 체력과 방어력으로 최전방에서 적을 막아서는 근접 전사다.',        0, 1300, 12, 100, 3.0, 0.05, 1.5, 1.2),
