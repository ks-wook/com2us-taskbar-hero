...
--   13) attendance_master  14) grade_master
...
--    3 Act × 2 난이도 × 4 스테이지 = 24종. 각 Act·난이도의 스테이지 4가 보스(boss_monster_code), 1~3은 0.
...
INSERT INTO stage_master (stage_id, act, difficulty, stage, boss_monster_code, background_type) VALUES
    ...
    (1010002, 1, 1, 2, 0,    1),
    (1010003, 1, 1, 3, 0,    1),
    (1010004, 1, 1, 4, 9099, 2),
    (1020001, 1, 2, 1, 0,    1),
    (1020002, 1, 2, 2, 0,    1),
    (1020003, 1, 2, 3, 0,    1),
    (1020004, 1, 2, 4, 9099, 2),
    (2010001, 2, 1, 1, 0,    3),
    (2010002, 2, 1, 2, 0,    3),
    (2010003, 2, 1, 3, 0,    3),
    (2010004, 2, 1, 4, 9199, 4),
    (2020001, 2, 2, 1, 0,    3),
    (2020002, 2, 2, 2, 0,    3),
    (2020003, 2, 2, 3, 0,    3),
    (2020004, 2, 2, 4, 9199, 4),
    (3010001, 3, 1, 1, 0,    5),
    (3010002, 3, 1, 2, 0,    5),
    (3010003, 3, 1, 3, 0,    5),
    (3010004, 3, 1, 4, 9299, 5),
    (3020001, 3, 2, 1, 0,    5),
    (3020002, 3, 2, 2, 0,    5),
    (3020003, 3, 2, 3, 0,    5),
    (3020004, 3, 2, 4, 9299, 5);
...
INSERT INTO stage_reward (stage_id, reward_gold, reward_exp, grade1_prob, grade2_prob, grade3_prob, grade4_prob, grade5_prob) VALUES
    ...
    (1010002, 120, 60, 0.30, 0.12, 0.03, 0.00, 0.00),
    (1010003, 150, 75, 0.30, 0.12, 0.03, 0.00, 0.00),
    (1010004, 500, 250, 0.20, 0.25, 0.10, 0.03, 0.00),
    (1020001, 250, 125, 0.25, 0.15, 0.05, 0.00, 0.00),
    (1020002, 300, 150, 0.25, 0.15, 0.05, 0.00, 0.00),
    (1020003, 375, 188, 0.25, 0.15, 0.05, 0.00, 0.00),
    (1020004, 1250, 625, 0.10, 0.25, 0.15, 0.05, 0.00),
    (2010001, 800, 400, 0.00, 0.20, 0.11, 0.04, 0.00),
    (2010002, 960, 480, 0.00, 0.20, 0.11, 0.04, 0.00),
    (2010003, 1200, 600, 0.00, 0.20, 0.11, 0.04, 0.00),
    (2010004, 4000, 2000, 0.00, 0.00, 0.20, 0.12, 0.06),
    (2020001, 2000, 1000, 0.00, 0.15, 0.15, 0.05, 0.00),
    (2020002, 2400, 1200, 0.00, 0.15, 0.15, 0.05, 0.00),
    (2020003, 3000, 1500, 0.00, 0.15, 0.15, 0.05, 0.00),
    (2020004, 10000, 5000, 0.00, 0.00, 0.15, 0.15, 0.10),
    (3010001, 6000, 3000, 0.00, 0.00, 0.15, 0.15, 0.05),
    (3010002, 7200, 3600, 0.00, 0.00, 0.15, 0.15, 0.05),
    (3010003, 9000, 4500, 0.00, 0.00, 0.15, 0.15, 0.05),
    (3010004, 30000, 15000, 0.00, 0.00, 0.00, 0.20, 0.17),
    (3020001, 15000, 7500, 0.00, 0.00, 0.00, 0.15, 0.13),
    (3020002, 18000, 9000, 0.00, 0.00, 0.00, 0.15, 0.13),
    (3020003, 22500, 11250, 0.00, 0.00, 0.00, 0.15, 0.13),
    (3020004, 75000, 37500, 0.00, 0.00, 0.00, 0.15, 0.23);
