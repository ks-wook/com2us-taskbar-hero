...
--    광역 스킬(401·403)로 실효 화력에서 앞선다(값 문서 §2 콘셉트 노트).
--    기사는 4직업 중 유일하게 광역이 전혀 없고(평타 단일 대상·사거리 1.5·주기 1.2초) 처리력이 가장 낮아,
--    한 방 수치(atk 21)와 생존(hp 1000 · def 60)을 함께 높여야 1지역 솔로가 성립한다(값 문서 §2·§9.2).
-- =====================================================================
...
INSERT INTO class_master (class_code, name, description, unlock_type, hp, atk, def, move_speed, crit_chance, crit_damage, cooldown) VALUES
    (1, '기사',   '높은 체력과 방어력으로 최전방에서 적을 막아서는 근접 전사다.',        0, 1000, 21, 60, 3.0, 0.05, 1.5, 1.2),
