...
--    5 Act(지역) × 2 난이도 × 10 스테이지 = 100종. 각 Act·난이도의 스테이지 10이 보스(boss_monster_code), 1~9는 0.
...
--      일반 몬스터 1종인 Act3~5 — 스테이지 1~9는 8→17마리로 증가, 보스 스테이지(10)는 8마리.
--      마리 수는 몬스터 hp와 함께 목표 클리어 시간(30초→50초, 보스 60초)을 만드는 축이다(값 문서 §9.1).
