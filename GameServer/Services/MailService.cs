...
public sealed class MailService : IMailService
{
    ...
    /// <summary>의존성(메일 리포지토리·마스터 데이터·로거)을 주입받는다.</summary>
    public MailService(IMailRepository mailRepository, MasterDataProvider masterData, ILogger<MailService> logger)
    {
