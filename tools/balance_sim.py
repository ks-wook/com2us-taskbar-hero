...
# 긴장도 목표(값 문서 §9.3) — 전투 중 파티가 떨어진 최저 체력 비율.
#   "아슬아슬하게 깨는 맛"을 위해 지역이 오를수록 좁힌다.
TENSION_S9 = {1: 0.46, 2: 0.48, 3: 0.35, 4: 0.34, 5: 0.30}
TENSION_BOSS = {1: 0.23, 2: 0.22, 3: 0.29, 4: 0.19, 5: 0.15}
