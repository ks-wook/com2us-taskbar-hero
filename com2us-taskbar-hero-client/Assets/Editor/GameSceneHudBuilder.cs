...
{
    /// <summary>
    /// GameScene 우하단 HUD 메뉴 버튼(편성·스테이지·가방)의 아이콘을 배선하는 에디터 도구.
    /// 아이콘은 Assets/Art/Icon(편성·스테이지·인벤토리)을 사용하며, Multiple로 임포트된 아이콘은 Single로 교정한다.
    ...
    public static class GameSceneHudBuilder
    {
        ...
        public static void Build()
        {
            ...
            Debug.Log("[GameSceneHudBuilder] 완료: GameScene HUD(편성·스테이지·가방) 아이콘 배선.");
        }
