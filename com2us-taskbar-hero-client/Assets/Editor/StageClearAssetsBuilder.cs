...
namespace TaskbarHero.ClientEditor
{
    ...
    public static class StageClearAssetsBuilder
    {
        ...
        private const string RewardTitleImagePath = "Assets/Art/UI/System/reward_ui.png";
        private const string DefeatTitleImagePath = "Assets/Art/UI/System/defeat.png";
        ...
        public static void Build()
        {
            ...
            asset.rewardTitleImage = LoadSprite(RewardTitleImagePath); // 보상 획득 연출 상단 타이틀 이미지
            asset.defeatTitleImage = LoadSprite(DefeatTitleImagePath); // 전투 패배 연출 타이틀 이미지
            ...
            Debug.Log($"[StageClearAssetsBuilder] 완료: 팡파레 {frames.Count}프레임, 아이템 아이콘 {icons.Count}종, " +
                      ...
                      $"경험치 아이콘 {(asset.expIcon != null ? "배선" : "없음")}, " +
                      $"보상 타이틀 이미지 {(asset.rewardTitleImage != null ? "배선" : "없음")}, " +
                      $"패배 타이틀 이미지 {(asset.defeatTitleImage != null ? "배선" : "없음")} → {AssetPath}");
        }
