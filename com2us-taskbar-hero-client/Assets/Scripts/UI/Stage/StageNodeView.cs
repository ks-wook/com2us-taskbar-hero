...
{
    /// <summary>
    /// 스테이지 선택 맵의 노드 한 칸(스테이지 1개). 해금/잠금 스프라이트·자물쇠·별·선택 하이라이트를
    ...
    public class StageNodeView : MonoBehaviour, IPointerClickHandler
    {
        ...
        public void EditorInit(int stage, Image nodeImage, GameObject lockIcon, GameObject highlight, Image[] stars)
        {
            _stage = stage;
        ...
        /// <summary>노드 스프라이트·자물쇠·별 개수를 반영한다.</summary>
        public void SetVisual(Sprite nodeSprite, bool locked, int starCount)
        {
            if (_nodeImage != null)
            {
