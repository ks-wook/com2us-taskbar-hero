...
public interface ISaveRepository
{
    ...
    /// <para>반환값은 <b>커밋 이후 이벤트 로그가 쓰는 식별자 둘</b>이다 — 발급된 신규 지원금 메일 id(5.8)와
    /// 지급된 기본 무기의 개체 id(6.2).</para></summary>
    Task<CreatePlayerOutcome> CreatePlayerWithFirstCharacterAsync(
